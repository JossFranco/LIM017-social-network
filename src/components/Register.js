...
export const register = () => {
  ...
  informationRegisterErr.setAttribute('class', 'information informationRegisterErr');
  ...
  btnRegisterUser.addEventListener('click', () => {
    ...
    document.getElementById('informationRegisterErr').textContent = 'Las contraseñas no coinciden.'
  }
